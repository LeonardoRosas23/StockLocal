...
import com.example.stocklocal.data.local.dao.MovementDao_Impl;
import com.example.stocklocal.data.local.dao.ProductDao;
import com.example.stocklocal.data.local.dao.ProductDao_Impl;
...
public final class StockLocalDatabase_Impl extends StockLocalDatabase {
  ...
  protected SupportSQLiteOpenHelper createOpenHelper(@NonNull final DatabaseConfiguration config) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(config, new RoomOpenHelper.Delegate(1) {
      ...
      public void createAllTables(@NonNull final SupportSQLiteDatabase db) {
        db.execSQL("CREATE TABLE IF NOT EXISTS `products` (`id` INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, `name` TEXT NOT NULL, `category` TEXT NOT NULL, `quantity` INTEGER NOT NULL, `price` REAL NOT NULL, `description` TEXT NOT NULL)");
        db.execSQL("CREATE TABLE IF NOT EXISTS `movements` (`id` INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, `productId` INTEGER NOT NULL, `productName` TEXT NOT NULL, `type` TEXT NOT NULL, `quantity` INTEGER NOT NULL, `date` INTEGER NOT NULL)");
        db.execSQL("CREATE TABLE IF NOT EXISTS room_master_table (id INTEGER PRIMARY KEY,identity_hash TEXT)");
        db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, 'e2bd1d2c47128845f4b3174c9b615a1a')");
      }
      ...
      public RoomOpenHelper.ValidationResult onValidateSchema(
        ...
        if (!_infoProducts.equals(_existingProducts)) {
          return new RoomOpenHelper.ValidationResult(false, "products(com.example.stocklocal.data.local.entity.Product).\n"
                  + " Expected:\n" + _infoProducts + "\n"
                  + " Found:\n" + _existingProducts);
        }
        ...
        _columnsMovements.put("productName", new TableInfo.Column("productName", "TEXT", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsMovements.put("type", new TableInfo.Column("type", "TEXT", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsMovements.put("quantity", new TableInfo.Column("quantity", "INTEGER", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        ...
        if (!_infoMovements.equals(_existingMovements)) {
          return new RoomOpenHelper.ValidationResult(false, "movements(com.example.stocklocal.data.local.entity.Movement).\n"
                  + " Expected:\n" + _infoMovements + "\n"
                  + " Found:\n" + _existingMovements);
        }
        return new RoomOpenHelper.ValidationResult(true, null);
      }
    }, "e2bd1d2c47128845f4b3174c9b615a1a", "f387c775ff3c0ac4e00bd2aec6326166");
  ...
  protected InvalidationTracker createInvalidationTracker() {
    ...
    return new InvalidationTracker(this, _shadowTablesMap, _viewTables, "products","movements");
  }
